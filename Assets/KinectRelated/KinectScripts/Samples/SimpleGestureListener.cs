	                              ...
	                              float progress, KinectInterop.JointType joint, Vector3 screenPos)
	{
		         ...
		         gesture == KinectGestures.Gestures.LeanRight) && progress > 0.5f)
		{
			if(gestureInfo != null) {
                ...
                //
                // This part sends the gesture information back to PlayerController, that determines the ships movement
                //
                PlayerController.kinectMoveLeft = 0;
                PlayerController.kinectMoveRight = 0;

                if (gesture == KinectGestures.Gestures.LeanLeft) {
                    PlayerController.kinectMoveLeft = 1;
                    PlayerController.kinectMoveRight = 0;
                } else if (gesture == KinectGestures.Gestures.LeanRight) {
                    PlayerController.kinectMoveLeft = 0;
                    PlayerController.kinectMoveRight = 1;
                }

                Debug.Log("Angle: " + screenPos.z);
